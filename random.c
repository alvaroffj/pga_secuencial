/*------------------------------------------------------------------------------*/
/* random.c - Contiene generador de nmeros aleatorios y utilidades relacionadas*/
...
// variables son declaradas estticas de modo que ellas no tengan conflictos
// con nombres de otras variables en otros archivos
static double  oldrand[55];   // Arreglo de 55 nmeros aleatorios
static int     jrand;         // Actual nmero aleatorio

void advance_random(void)
// Crea batch de 55 nmeros aleatorios
{
   	int j1;
   	double new_random;
