...
${OBJECTDIR}/app_ng.o: app_ng.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/app_ng.o app_ng.c
...
${OBJECTDIR}/app_ir.o: app_ir.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/app_ir.o app_ir.c

${OBJECTDIR}/app_sc_ng.o: app_sc_ng.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/app_sc_ng.o app_sc_ng.c
...
${OBJECTDIR}/app2_sc_ng.o: app2_sc_ng.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/app2_sc_ng.o app2_sc_ng.c

${OBJECTDIR}/app_irb.o: app_irb.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/app_irb.o app_irb.c
...
${OBJECTDIR}/app2_ng.o: app2_ng.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/app2_ng.o app2_ng.c
...
${OBJECTDIR}/app2_irb.o: app2_irb.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/app2_irb.o app2_irb.c
...
${OBJECTDIR}/app2_ir.o: app2_ir.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/app2_ir.o app2_ir.c
